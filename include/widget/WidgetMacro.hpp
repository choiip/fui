...
#define FUI_WIDGET_PROPERTY(TYPE, NAME, DEFAULT)                                                                       \
public:                                                                                                                \
...
#define FUI_WIDGET_READONLY_PROPERTY(TYPE, NAME, DEFAULT)                                                              \
public:                                                                                                                \
  const TYPE& NAME() const { return _##NAME; }                                                                         \
                                                                                                                       \
protected:                                                                                                             \
...
#define FUI_WIDGET_PROPERTY_ALT_SETTER(TYPE, NAME, DEFAULT)                                                            \
public:                                                                                                                \
  auto NAME(const TYPE& v)->decltype(this);                                                                            \
  const TYPE& NAME() const { return _##NAME; }                                                                         \
                                                                                                                       \
